      ...
      <div className="container" style={{ paddingTop: '8rem', paddingBottom: '4rem' }}>
        ...
        <div className="glass-panel" style={{ padding: '3rem' }}>
          ...
          <p style={{ fontSize: '1.1rem', color: 'var(--text-muted)', marginBottom: '1.5rem' }}>
            FreeFlow Media bridges the gap between raw data and creative excellence. We are a collective of digital strategists, creators, and performance marketers dedicated to scaling businesses through transparent, result-oriented marketing.
          </p>
